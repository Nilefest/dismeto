 ...
 *
 */
class Ukraine extends Stem
{
    /**
     * All russian vowels
     */
    protected static $vowels = array('а', 'е', 'и', 'о', 'у', 'и', 'э', 'ю', 'я');

    protected static $perfectiveGerund = array(
        array('вшись', 'вши', 'в'),
        array('ившись', 'вшись', 'ивши', 'ивши', 'ив', 'ив')
    );

    protected static $adjective = array(
        'ими', 'їми', 'йому', 'ому', 'його', 'ого', 'ее', 'ие', 'ие', 'ое', 'ей', 'ий',
        'ий', 'ой', 'ем', 'им', 'им','ом','их', 'их', 'ую', 'юю', 'ая', 'яя', 'ою', 'ею'
    );
    ...
    protected static $verb = array(
        array('їш', 'нно', 'ете', 'йте', 'ла', 'на', 'ли', 'й', 'л', 'ем', 'н', 'ло', 'но', 'ет', 'ют', 'ни', 'ть'),
        array(
            'уйте', 'ило', 'ило', 'ено','ила', 'ила', 'ена', 'ейте', 'ени', 'ить', 'ить', 'ишь', 'ите', 'или', 'или',
            'ует', 'уют', 'ей', 'уй', 'ил', 'ил', 'им', 'им', 'ен', 'ят', 'ит', 'ит', 'ую', 'ю'
        )
    );

    protected static $noun = array(
        'иями', 'ями', 'ами', 'ией', 'иям', 'ием', 'иях', 'ев', 'ов', 'ие', 'ье', 'еи', 'ии', 'ей', 'ой', 'ий', 'ям',
        'ем', 'ам', 'ом', 'ах', 'ях', 'ию', 'ью', 'ия', 'ья', 'я', 'а', 'е', 'и', 'ь', 'и', 'о', 'у', 'й', 'ю'
    );
